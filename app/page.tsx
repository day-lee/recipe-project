      ...
      <div className="flex-1 w-full flex flex-col gap-20 items-center">
        ...
        <div className="flex-1 flex flex-col gap-10 max-w-5xl p-5 items-center">
          <div className="flex flex-col items-center">
            ...
            <p className="text-lg sm:text-2xl text-gray-800 text-center font-normal animate-fade-down animate-once">{catchPhrase}</p>
            <div className="flex items-center mt-1 sm:mt-4 ">
              <Image src={icon} priority={true} className="w-8 h-8 animate-wiggle-more animate-delay-300 animate-twice" alt="logo"/>
